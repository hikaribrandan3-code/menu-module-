...
export function LanguageProvider({ children }) {
  ...
  const t = (key) => {
    const translations = {
      ...
      'cuisine_library_label': 'Full Control',
      'menu_offerings_title': 'Menu Management',
      'curate_vision_subtitle': 'Simple tagging, full control. Diet-friendly, spicy, natural, promoted—your way.',
      'new_recipe_button': 'New Recipe',
      'delivery_system_title': 'Delivery Control',
      'delivery_system_subtitle': 'Simple setup. Full flexibility. Range, fees, pause anytime—customize completely.',
